use entity::{profile_data, test_action, test_case, test_step, user};
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(test_case::Column::Id)
                            .integer()
                            .not_null()
                            .auto_increment()
                            .primary_key(),
                    ...
                    .col(
                        ColumnDef::new(test_case::Column::IsDeleted)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    .table(test_action::Entity)
                    .if_not_exists()
                    .col(
                        ColumnDef::new(test_action::Column::Id)
                            .integer()
                            .not_null()
                            .auto_increment()
                            .primary_key(),
                    ...
                    .col(
                        ColumnDef::new(test_action::Column::Command)
                            .text()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(test_action::Column::Target)
                            .text()
                            .not_null(),
                    )
                    .col(ColumnDef::new(test_action::Column::Selector).text())
                    .col(ColumnDef::new(test_action::Column::Value).text())
                    .col(ColumnDef::new(test_action::Column::Output).text())
                    .col(ColumnDef::new(test_action::Column::Desc).text())
                    .col(
                        ColumnDef::new(test_action::Column::ExecutionOrder)
                            .integer()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(test_action::Column::TestCaseId)
                            .integer()
                            .not_null(),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk-test-case-id")
                            .from_tbl(test_action::Entity)
                            .to_tbl(test_case::Entity)
                            .from_col(test_action::Column::TestCaseId)
                            .to_col(test_case::Column::Id)
                            .on_delete(ForeignKeyAction::Cascade)
                            .on_update(ForeignKeyAction::Cascade),
                    )
                    .to_owned(),
