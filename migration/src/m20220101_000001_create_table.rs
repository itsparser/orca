...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
                ...
                Table::create()
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from_tbl(user_role::Entity)
                            .to_tbl(role::Entity)
                            .from_col(user_role::Column::RoleId)
                            .to_col(role::Column::Id),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from_tbl(user_role::Entity)
                            .to_tbl(user::Entity)
                            .from_col(user_role::Column::UserId)
        ...
        manager
            .create_table(
                Table::create()
                    .table(role_scope::Entity)
                    .if_not_exists()
                    .col(
                        ColumnDef::new(role_scope::Column::Id)
                            .integer()
                            .not_null()
                            .auto_increment()
                            .primary_key(),
                    ...
                    .col(
                        ColumnDef::new(role_scope::Column::RoleId)
                            .integer()
                            .not_null(),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk-role-scope-role-id")
                            .from_tbl(role_scope::Entity)
                            .to_tbl(role::Entity)
                            .from_col(role_scope::Column::RoleId)
                            .to_col(role::Column::Id),
                    )
                    .to_owned(),
            )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(audit_log::Column::ActedBy)
                            .integer()
                            .not_null(),
                    )
                    .col(
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from_tbl(audit_log::Entity)
                            .to_tbl(user::Entity)
                            .from_col(audit_log::Column::ActedBy)
                            .to_col(user::Column::Id),
                    )
                    .to_owned(),
            )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(user_session::Column::SessionId)
                            .text()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(user_session::Column::SessionType)
                            .text()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(user_session::Column::Email)
                            .text()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(user_session::Column::UserAgent)
                            .text()
                            .not_null(),
                    )
                    .col(
                    ...
                    .col(
                        ColumnDef::new(user_session::Column::ExpiresBy)
                            .timestamp()
                            .not_null(),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from_tbl(user_session::Entity)
                            .to_tbl(user::Entity)
                            .from_col(user_session::Column::UserId)
                            .to_col(user::Column::Id),
                    )
                    .to_owned(),
            )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(profile::Column::IsDefault)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
